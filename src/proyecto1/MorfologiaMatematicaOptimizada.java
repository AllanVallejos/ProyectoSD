...
public class MorfologiaMatematicaOptimizada {
    ...
    static class ElementoEstructurante {
        ...
        public ElementoEstructurante(int[][] estructura) {
        ...
        private int calcularErosionRGB(int x, int y) {
            ...
            for (int ey = 0; ey < elemento.height; ey++) {
                for (int ex = 0; ex < elemento.width; ex++) {
                    if (!elemento.isActive(ex, ey)) continue;
                    
                    int px = x + ex - elemento.centerX;
                    int py = y + ey - elemento.centerY;
    ...
    public static ElementoEstructurante crearCruz3x3() {
        ...
        return new ElementoEstructurante(estructura);
    }
    
    public static ElementoEstructurante crearCuadrado3x3() {
        int[][] estructura = {
            {1, 1, 1},
            {1, 1, 1},
            {1, 1, 1}
    ...
    public static ElementoEstructurante crearLinea3x1() {
        int[][] estructura = {{1, 1, 1}};
        return new ElementoEstructurante(estructura);
    }
    
    public static ElementoEstructurante crearDiagonal3x3() {
        int[][] estructura = {
            {1, 0, 0},
            {0, 1, 0},
            {0, 0, 1}
    ...
    public static ElementoEstructurante crearCuadrado5x5() {
        int[][] estructura = new int[5][5];
        for (int i = 0; i < 5; i++) {
            for (int j = 0; j < 5; j++) {
                estructura[i][j] = 1;
            }
